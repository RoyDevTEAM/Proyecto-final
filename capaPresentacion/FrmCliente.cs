    ...
    public partial class FrmCliente : Form
    {
        ...
        private void FrmCliente_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                dataGridView1.DefaultCellStyle.Font = new System.Drawing.Font("Arial", 13);

                dataGridView1.RowTemplate.Height = 40;

                dataGridView1.Columns["id_cliente"].Width = 80; // Cambia "Nombre_Columna1" al nombre de la primera columna y 150 al ancho deseado
                dataGridView1.Columns["nombre_cliente"].Width = 220;
                dataGridView1.Columns["apellido_cliente"].Width = 240;
                dataGridView1.Columns["numero_carnet"].Width = 160;
                dataGridView1.Columns["telefono"].Width = 160;
                dataGridView1.Columns["direccion"].Width = 270;
                dataGridView1.Columns["estado"].Width = 100;
                dataGridView1.Columns["Editar"].Width = 200;

                dataGridView1.Columns["id_cliente"].HeaderText = "ID"; // Cambia "Nombre_Columna1" al nombre de la primera columna y "Nuevo Nombre 1" al nuevo nombre deseado
                dataGridView1.Columns["nombre_cliente"].HeaderText = "Nombre Cliente";
                dataGridView1.Columns["apellido_cliente"].HeaderText = "Apellido Cliente";
                dataGridView1.Columns["numero_carnet"].HeaderText = "Carnet Identidad";
                dataGridView1.Columns["telefono"].HeaderText = "Telefono";
                dataGridView1.Columns["direccion"].HeaderText = "Direccion";
                dataGridView1.Columns["estado"].HeaderText = "Estado";
                dataGridView1.Columns["Editar"].HeaderText = "Editar";

                //dataGridView1.Columns["Nombre_Columna2"].HeaderText = "Nuevo Nombre 2";



                foreach (DataGridViewColumn column in dataGridView1.Columns)
                {
                    // Cambia "Arial" por la fuente que desees, 14 por el tamaño deseado y FontStyle.Bold si deseas que sea en negrita
